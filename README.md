...
* [img2threejs](https://github.com/hoainho/img2threejs) ⭐ 14,340 | 🐛 72 | 🌐 Python | 📅 2026-08-26: Rebuild the object in a reference image as a code-only, procedural, quality-gated Three.js model. Pure-Python stdlib tooling emits diffable TypeScript, no downloaded meshes. by [@hoainho](https://github.com/hoainho)
...
* [Shader Park](https://shaderpark.com/): A JavaScript library for creating interactive procedural 2D and 3D shaders. Helpful for raymarching shaders (the raymarcher is already built-in, SDFs and boolean operation between them already available). Works both in p5js style and GLSL. ([to contribute](https://github.com/shader-park/shader-park-core) ⭐ 823 | 🐛 42 | 🌐 JavaScript | 📅 2024-05-28) by [@shader-park](https://github.com/shader-park)
...
* [react-three-fiber](https://github.com/pmndrs/react-three-fiber) ⭐ 31,820 | 🐛 51 | 🌐 TypeScript | 📅 2026-08-28: A declarative way of handling your ThreeJS stuff for
  React by [@pmndrs](https://github.com/pmndrs)
* [drei](https://github.com/pmndrs/drei) ⭐ 9,824 | 🐛 108 | 🌐 JavaScript | 📅 2026-08-25: Useful helpers for react-three-fiber by [@pmndrs](https://github.com/pmndrs)
* [react-postprocessing](https://github.com/pmndrs/react-postprocessing) ⭐ 1,383 | 🐛 20 | 🌐 TypeScript | 📅 2026-08-27: A postprocessing wrapper for @react-three/fiber by [@pmndrs](https://github.com/pmndrs)
...
* [TresJs](https://github.com/tresjs/tres) ⭐ 3,677 | 🐛 101 | 🌐 Vue | 📅 2026-08-17: Declarative ThreeJS using Vue Components by [@tresjs\_dev](https://github.com/Tresjs)
...
* [Threlte](https://github.com/threlte/threlte) ⭐ 3,334 | 🐛 67 | 🌐 Svelte | 📅 2026-08-28: A three.js component library for Svelte
...
* [three-mesh-bvh](https://github.com/gkjohnson/three-mesh-bvh) ⭐ 3,464 | 🐛 84 | 🌐 JavaScript | 📅 2026-08-10 by [@gkjohnson](https://github.com/gkjohnson/): Highly effective way to check for collisions and to accelerate raycasting by the usage of bounding volume hierarchy. (Really a must have in your toolkit)
...
* [Three-pathfinding](https://github.com/donmccurdy/three-pathfinding) ⭐ 1,369 | 🐛 7 | 🌐 JavaScript | 📅 2026-07-08 Three.js plugin for navigation
...
* [awesome-creative-coding](https://github.com/terkelg/awesome-creative-coding) ⭐ 15,253 | 🐛 8 | 🌐 HTML | 📅 2026-07-21 - A carefully curated list of awesome
...
* [awesome-webgl](https://github.com/sjfricke/awesome-webgl) ⭐ 1,528 | 🐛 16 | 📅 2026-04-02 - A curated list of awesome WebGL libraries, resources and
  much more.
